...
#		self.notifier = notifier 	
	...
	def myOnMessageReceived (self, paho_mqtt , userdata, msg):
		...
		if json_msg["n"] == "Boiler":
			self.myPublish("/tiot/boiler", {"value": json_msg["v"]})
		elif json_msg["n"] == "Window":
			self.myPublish("/tiot/window", {"value": json_msg["v"]})
		elif json_msg["n"] == "Esterno":
			self.myPublish("/tiot/23/sw4/pir", {"value": json_msg["v"]})
	...
	def myPublish (self, topic, msg):
		...
		self.mqtt_client.publish(topic, str_msg, 2)
